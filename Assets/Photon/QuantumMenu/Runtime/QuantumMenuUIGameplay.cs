namespace Quantum.Menu {
  ...
  public partial class QuantumMenuUIGameplay : QuantumMenuUIScreen {
    ...
    private static extern void QuantumCopyToClipboard(string text);
#else
    private static void QuantumCopyToClipboard(string text) => GUIUtility.systemCopyBuffer = text;
#endif
    ...
    protected virtual void OnCopySessionPressed() {
      QuantumCopyToClipboard(_codeText.text);
    }
